...
a.equals(b)                    // true</pre>
    ...
    <p>
      ...
      and returns a reference to the self Decimal constructor so it can be assigned to a
...
x.valueOf()                              // '-0'</pre>
    ...
    <p>
      As with JavaScript numbers, the self exponent and fractional trailing zeros of a value
      are not preserved.
    </p>
    <pre>
